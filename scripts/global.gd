...
func load_local_settings():
	...
	#Fullscreen
	var fullScreen: bool = LocalSaveSystem.get_data(LocalSaveSystem.Sections.SETTINGS, "graphics_fullscreen", false)
	if fullScreen:
	...
	#FPS
	var fps: int = LocalSaveSystem.get_data(LocalSaveSystem.Sections.SETTINGS, "graphics_fps_limit", 60 as int)
	Engine.max_fps = fps
	
	#Shadow quality
	var shadows: int = LocalSaveSystem.get_data(LocalSaveSystem.Sections.SETTINGS, "graphics_shadow_quality", 2 as int)
	...
	var halfIllumination: bool = LocalSaveSystem.get_data(LocalSaveSystem.Sections.SETTINGS, "graphics_global_illumination_halved", false)
	RenderingServer.gi_set_use_half_resolution(halfIllumination)
	
	#Antialiasing
	var antiAliasing: int = LocalSaveSystem.get_data(LocalSaveSystem.Sections.SETTINGS, "graphics_antialiasing_msaa", 0 as int)
	...
	#Language
	var locale: String = LocalSaveSystem.get_data(LocalSaveSystem.Sections.SETTINGS, "language_locale", "en")
	TranslationServer.set_locale(locale)

	#VSync
	var vSync: int = LocalSaveSystem.get_data( LocalSaveSystem.Sections.SETTINGS, "graphics_vsync_mode", 1 as int)
