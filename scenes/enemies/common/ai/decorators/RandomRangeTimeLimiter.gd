...
class_name RandomRangeTimeLimiterDecorator extends Decorator

@export var minimum_wait_time := 0.0
@export var maximum_wait_time := 0.0

var time_left := 0.0

@onready var child: BeehaveNode = get_child(0)
@onready var wait_time := randf_range(minimum_wait_time, maximum_wait_time)
...
func get_class_name() -> Array[StringName]:
	var classes := super()
	classes.push_back(&"RandomRangeTimeLimiterDecorator")
	return classes
